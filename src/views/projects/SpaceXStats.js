  ...
  <article>
    ...
    <section className="Content">
      <p>
        ...
        disaster and the retirement of the Space Shuttle. However in april 2016
        ...
        on YouTube and I was mindblown.
      </p>

      <img
        src="/img/projects/spacexstats/oglogo.jpg"
        alt="An overview of SpaceX Stats"
      />
      ...
      <p>
        ...
        the front-end with React, using{" "}
        <a
          className="Link"
          href="https://github.com/r-spacex/SpaceX-API"
          title="The API of the SpaceX subreddit"
          target="_blank"
          rel="noreferrer noopener"
        >
          r/spacex’s API
        ...
        original website. You can also visit{" "}
        <a
          className="Link"
          href="https://github.com/r-spacex/spacexstats-react"
          title="The repo of the website"
          target="_blank"
          rel="noreferrer noopener"
        >
