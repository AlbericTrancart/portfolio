...
export default () => (
  <article>
    ...
    <section className="Content">
      ...
      <p>
        In 2015, a friend of mine had a problem: he was looking for an
        internship in Sweden and seeking feedback from people who went there.
        Although these people existed and surely met him on a daily basis, he
        was unable to find them. After gathering useful information (like: who
        went where, the cost of living, the temperature, the price of a beer…{" "}
        <em>useful information</em>) amongst students with a Google Sheet which
        had a huge success, he decided to create a web platform to centralize
        and search through this data. GéoPonts (named after the name of our
        school) was born.
      </p>
      ...
      <p>
        This is an ongoing project but so far it is one of the best working
      ...
      <h2 style={{ textAlign: "center" }}>
        <a
          className="Link"
          href="https://demo.geoschool.fr"
          title="Visit the demo website"
          target="_blank"
