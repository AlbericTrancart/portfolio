      ...
      <View location={location}>
        <section>
          ...
          <p className="mtop">
            ...
            École Nationale des Ponts et Chaussées (ENPC). I am passionate about
          ...
          <p className="mtop">
            But most of all, I love learning! As a consequence, I will post
            about what I believe is worth sharing.{" "}
            <strong>
            ...
            <br />
            <em>
              All posts will be in english. I may publish a french version for
              the most critical topics or if there is a demand for it (don’t
              hesitate to correct my english if I made a mistake! I welcome any
              kind of feedback).
            </em>
          </p>
        </section>
