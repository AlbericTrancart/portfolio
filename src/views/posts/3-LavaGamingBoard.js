...
export default () => (
  <article>
    ...
    <section className="Content">
      <p>
        This summer as I had some free time I decided to build what my
        collection of minis missed: a decent-looking gaming board. Having
        already played with full-painted armies on great gaming boards, I knew
        that’s what I lacked to change cool battles into awesome battles.
      </p>
    ...
    <section className="Content">
      ...
      <p>
        Taking the criteria into account, it was obvious that the table had to
        be modular. I decided to go with 30cm squares (about 1 foot): they are
        easy to store and provide a lot of possible configurations. Then I
        sketched the modules on a paper sheet to test some configurations and to
        balance the surface occupied by the lava rivers.
      </p>
      ...
      <p>
        <strong>TOTAL:</strong> 114€ (about $125)
      </p>
      ...
      <p>
        8 modules can be built from each foam sheet. Using a plywood square as a
        guide, I cut through the foam with a very sharp knife.
      </p>
      ...
      <p>
        For two other modules I made some rifts with the same
        scissors-technique, but on a larger scale.
      </p>

      <img src={`${imgdir}image13.jpg`} alt="Rifts modules" />

      <p>
        I also wanted really special modules. To make these, I used the
        remaining foam to build a mountain in the corner/a volcano in the center
        of another one.
      </p>
      ...
      <p>
        Then I covered it with paper mache (that’s where the plaster has a role
        to play) to get a smooth and hard surface.
      </p>
      ...
      <p>
        After that, I applied a brown wash on the walls and I painted the
        details with brown and bronze colors. I love speed painting techniques
        and here I was satisfied by the ruins painted in less than 20 minutes.
      </p>
      ...
      <p>
        Here is the trick of this whole project: using the black latex wall
        paint. It behaves as a glue, a base layer and a colour layer at the same
        time. The goal is to seal the sand between two layers of paint – and
        believe me, it works very well. So first of all, let’s apply a generous
        first coat.
      </p>
      ...
      <p>
        I got all the loose sand off, then I brushed another thick coat of
        paint.
      </p>
      ...
      <p>
        ...
        all the foam scrap I got and mixed them into the sand during the
        texturing phase.
      </p>
      ...
      <p>
        I covered this lava with yellow paint, leaving white spots in some
        places.
      </p>
      ...
      <p>
        I finished with a drybrush of black paint on the topmost part of the
        lava.
      </p>
    ...
    <section className="Content">
      ...
      <p>
        Here is the table with a lot of minis so you can grasp how it feels to
        play on it.
      </p>
    ...
    <section className="Content">
      ...
      <p>
        ...
        dangerous terrain tests while crossing but you can’t end up your
        movement in the lava. It is more a strategic challenge than a real
        constraint. In addition, you have the bridges, which are of strategic
        interest, but not by much.
      </p>

      <p>
        Looking back at the criteria I was satisfied with the table I made. If
        there is one word to describe the success of the project, it is “speed”.
