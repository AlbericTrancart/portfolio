    ...
    <article>
      ...
      <section className="Content">
        <p>
          ...
          important, how and when it will happen. This one will be in the
          history books, so you better learn about it!
        </p>
        <h2>What it is</h2>
        <p>
        ...
        <ul>
          <li>
            At the bottom (under the black separation line), the first stage
            which is called the Super Heavy booster. Its role is to accelerate
            the second stage out of the atmosphere.
          </li>
          <li>
        ...
        <ul>
          <li>
            <em>It can lift a lot at once.</em> Current rockets can lift about
            ~20 tons to Low Earth Orbit, whereas{" "}
          ...
          <li>
            ...
            <strong>
              if you land a Starship on Mars, you can return to Earth for free
              by producing methane there.
            </strong>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            PhD at Moon Base Alpha, joining the 1,000 other scientists there for
            a two year stay
          </li>
          <li>
            A Mars colony - you regularly exchange video messages with your
            friend who sold his house to move to another planet and start a new
            life
          </li>
          <li>
        ...
        <p>
          ...
          However, SpaceX has only reused first stages so far, which means that
          a lot of costly parts must still be manufactured for each launch.
        </p>
        <figure>
          <img
        ...
        <p>
          ...
          . The SpaceX team is hell-bent on landing a Starship on Mars by 2024.
          To achieve this goal, they are moving really, really fast. Here is an
        ...
        <p>
          To test its Raptor engine in real flight conditions, SpaceX contracted
          a water tower company to rapidly assemble a working Starship
          prototype. This prototype made hops (the highest at 150 meters){" "}
          <strong>
        ...
        <p>
          ...
          validate a heat shielding technology and to prove that second stages
        ...
        <figure>
          <img
            src={`${imgdir}florida.jpg`}
            alt="Starship prototype in Florida"
          />
          <figcaption>
        ...
        <p>
          ...
          . Also, it will make the rocket pay for itself (which is an
          achievement, considering the size of the thing).
        </p>
        <figure>
        ...
        <p>
          ...
          towards Mars.{" "}
          <strong>
            The goal will be to prove that Earth landing technologies also work
            on Mars.
          </strong>
        </p>
        <figure>
        ...
        <p>
          After putting cargo in orbit, the next challenge will be to develop
          the crewed version and send people with it.{" "}
          <strong>
        ...
        <p>
          ...
          <strong>
            SpaceX's goal is to land two cargo and two crewed Starships on Mars
            in five years.
          </strong>{" "}
        ...
        <p>
          ...
          really ambitious. I think the crewed version will take longer to
          develop as human-rating a rocket system for a 3 years journey will not
          be simple.
          <strong>
            My bet is that the first cargo Starship will land on Mars in 2024
            and that the first human footprints will happen before 2030.
          </strong>{" "}
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Know more about Starship, Raptor engine or anything related to
            rocket science,{" "}
            <a
              className="Link"
              target="_blank"
